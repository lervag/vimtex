...
Notes from a registered author (\FXRegisterAuthor) should also be detected.
\jdnote{Sed ut perspiciatis unde omnis iste natus error.}
Donec sit amet risus augue. \jderror{Nemo enim ipsam voluptatem quia voluptas.}
\jdwarning*{Neque porro quisquam est}{Qui dolorem ipsum quia dolor sit amet.}

\begin{ajdwarning}{Ut enim ad minima veniam}
  Quis nostrum exercitationem ullam corporis suscipit laboriosam.
\end{ajdwarning}

\begin{ajdnote*}{Quis autem vel eum}{Iure reprehenderit qui in ea voluptate.}
