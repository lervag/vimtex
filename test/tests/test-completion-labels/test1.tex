...
\includeonly{included/sub1,included/sub2 with spaces}
...
\include{"included/sub2\space with\space spaces"}

\include{included/sub4}

\input{"included/sub3\space with\space spaces"}
