...
function! vimtex#syntax#p#ieeetrantools#load() abort " {{{1
  ...
  call s:new_math_region('IEEEeqnarray')
  call s:new_math_region('IEEEeqnarrayboxm')
endfunction

" }}}1

function! s:new_math_region(mathzone) abort " {{{1
  " This needs to be slightly different than vimtex#syntax#core#new_math_region
